...
describe('Example Display', () => {
  ...
  it('should display examples', () => {
    // when
    render(<ExampleDisplay wordId={wordId} examples={examples} showExamples={true} deleteExample={deleteExample}/>);
  ...
  it('should not show examples if showExamples is false', () => {
    // when
    render(<ExampleDisplay wordId={wordId} examples={examples} showExamples={false} deleteExample={deleteExample}/>);
  ...
  it('should show a placeholder if no examples are provided', () => {
    // when
    render(<ExampleDisplay wordId={wordId} examples={[]} showExamples={true} deleteExample={deleteExample}/>);
